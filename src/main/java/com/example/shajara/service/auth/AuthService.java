    ...
    public AppResponse<String> registration(RegistrationDTO dto){
        ...
        if(optional.isPresent()){
            ...
            if(profile.getStatus().equals(GeneralStatus.IN_REGISTRATION)){
                ...
                //throw new AppBadException(messageSource.getMessage("email.phone.exist",null,new Locale(lang.name())));
...
//        //smsni tasdiqlaagandan keyin qayta login qilib o'tirmasin to'g'ri kirsin accountiga
//
//
//        return getLogInResponse(profile);
...
//        return "yangi sms muaffiqiyatli qayta jo'natildi !";
    ...
    public AppResponse<String> resetPasswordConfirm(ResetPasswordConfirmDTO dto) {//parolni o'zgartirayotganda tasdiqlash kodni
