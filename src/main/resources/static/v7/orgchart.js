...
var OrgChart = function (t, e) {
    ...
    (Object.defineProperty(this, "element", {
        get: () => (t ? t.querySelector("[data-boc-content]") : null),
        set(t) {
            r.mainElement = t;
        },
    }),
...
((OrgChart.prototype.init = function (t, e) {
            ...
            for (var i in this.config.tags) {
                ...
                null != n.subTreeConfig &&
                    (this._layoutConfigs[i] = {
                        ...
                        template: n.subTreeConfig.template,
                    });
            }
    ...
    (OrgChart.prototype._createMasterSvg = function (t, e, r, i, n) {
        ...
        ((h.innerHTML = `${o.header.replaceAll("{current-page}", r + 1).replaceAll("{total-pages}", i.pages.length)}`),
            s.appendChild(h),
        ...
        ((d.innerHTML = `${o.footer.replaceAll("{current-page}", r + 1).replaceAll("{total-pages}", i.pages.length)}`),
            s.appendChild(d),
        ...
        if (!(e.button > 0)) {
            for (var r = e.target; r != t;) {
                ...
                if (r.hasAttribute(OrgChart.attr.control_node_circle_menu_name))
                    return (
                        e.stopPropagation(),
                        void this._nodeCircleMenuItemClickHandler(r, e)
                    );
            ...
            if (n.hasAttribute) {
                ...
                (n.hasAttribute(OrgChart.attr.node_id)
                    ...
                    : n.hasAttribute(OrgChart.attr.control_expcoll_id)
                        ? (a = this.getNode(
                            n.getAttribute(OrgChart.attr.control_expcoll_id),
                        ))
                        : (n.hasAttribute(OrgChart.attr.control_node_menu_id) ||
                            n.hasAttribute(OrgChart.attr.control_node_menu_id)) &&
                        (a = this.getNode(
                    ...
                    i ||
                    (i = OrgChart._getScrollableTreeListNodeInTouchEnabledDevice(a)));
            }
            if (
                n.hasAttribute(OrgChart.attr.node_id) &&
                !i &&
        ...
        if (this.isVisible && 0 != t && 0 != e) {
            ...
            if (r) {
                ...
                (Math.abs(this._lastSize.width - t) >
                    Math.abs(this._lastSize.height - e)
                    ? (r[3] = e / i)
                    : (r[2] = t / n),
                    this.nodeMenuUI.hide(),
                    this.nodeContextMenuUI.hide(),
                    ...
                    : "ArrowUp" == t.key
                        ...
                        : "Enter" == t.key
                            ...
                            : "Escape" == t.key
                                ? e.hide()
                                : this.value.length >=
                                OrgChart.MINIMUM_SYMBOLS_IN_SEARCH_INPUT && e._search();
            }));
        var c = function () {
            ...
            for (var r = [], i = 0; i < t.groupDottedLines.length; i++) {
                ...
                if (!r.has(a))
                    for (var o = 0; o < e.length; o++)
                        if (e[o].id == n.rootId) {
                            (((c = JSON.parse(JSON.stringify(e[o]))).id =
                                `balkan_group_dotted_${n.rootId}_balkan_id_${e[o].id}`),
                                (c.pid = void 0),
                                (c.stpid = e[o].id),
                                e.push(c),
                                r.push(a),
            ...
            for (i = 0; i < t.dottedLines.length; i++) {
                ...
                for (o = 0; o < e.length; o++)
                    if (e[o].id == h.from) {
                        ...
                        if (
                            (((c = JSON.parse(JSON.stringify(e[o]))).id =
                                `balkan_dotted_${h.rootId}_balkan_id_${e[o].id}`),
                                h.rootId == h.to
                                    ? (c.pid = h.to)
    ...
    (OrgChart.templates.base = {
        ...
        plus: function (t, e, r, i, n) {
            ...
            return `<g transform="matrix(1,0,0,1,${n.x - 15},${n.y - 15})"><circle cx="15" cy="15" r="15" fill="${a}" stroke="#aeaeae" stroke-width="1"></circle>\n        <text text-anchor="middle" style="font-size: 14px;cursor:pointer;" fill="#aeaeae" x="15" y="21">${t.deepCollapsedChildCount}</text></g>`;
        },
    ...
    (OrgChart.templates.ana = {
        ...
        nodeMenuButton: function (t, e, r, i) {
            return `<g transform="matrix(1,0,0,1,${t.w - 25},${t.h - 15})"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>`;
        },
    ...
    (OrgChart.templates.ula.nodeMenuButton = function (t, e, r, i) {
        return `<g transform="matrix(1,0,0,1,${t.w - 25}, ${t.h - 15})"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#AEAEAE"></circle><circle cx="7" cy="0" r="2" fill="#AEAEAE"></circle><circle cx="14" cy="0" r="2" fill="#AEAEAE"></circle></g>`;
    }),
    ...
    (OrgChart.templates.olivia.nodeMenuButton = function (t, e, r, i) {
        return `<g style="cursor:pointer;" transform="matrix(1,0,0,1,${t.w - 25},${t.h - 15})"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#AEAEAE"></circle><circle cx="7" cy="0" r="2" fill="#AEAEAE"></circle><circle cx="14" cy="0" r="2" fill="#AEAEAE"></circle></g>`;
    }),
    ...
    (OrgChart.templates.belinda.node = function (t, e, r, i) {
        return `<circle cx="${t.w / 2}" cy="${t.h / 2}" r="${t.w / 2}" fill="#039BE5" stroke-width="1" stroke="#aeaeae"></circle>`;
    }),
    (OrgChart.templates.belinda.img_0 = function (t, e, r, i, n) {
        var a = t.w / 2,
            o = OrgChart.randomId();
        return `<clipPath id="${o}"><circle cx="${a}" cy="45" r="40"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${o})" xlink:href="${n}" x="${a - 40}" y="5" width="80" height="80" ></image>`;
    }),
    ...
    (OrgChart.templates.rony.img_0 = function (t, e, r, i, n) {
        var a = t.w / 2,
            o = OrgChart.randomId();
        return `<clipPath id="${o}"><circle cx="${a}" cy="160" r="60"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${o})" xlink:href="${n}" x="${a - 60}" y="100" width="120" height="120" ></image>`;
    }),
    ...
    (OrgChart.templates.rony.plus = function (t, e, r, i, n) {
        return `<g transform="matrix(1,0,0,1,${n.x - 15},${n.y - 15})"><circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#039BE5" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#039BE5"></line><line x1="15" y1="4" x2="15" y2="26" stroke-width="1" stroke="#039BE5"></line></g>`;
    }),
    (OrgChart.templates.rony.minus = function (t, e, r, i, n) {
        return `<g transform="matrix(1,0,0,1,${n.x - 15},${n.y - 15})"><circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#039BE5" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#039BE5"></line></g>`;
    }),
    (OrgChart.templates.rony.nodeMenuButton = function (t, e, r, i) {
        return `<g transform="matrix(1,0,0,1,${t.w - 25},${t.h - 15})"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#F57C00"></circle><circle cx="7" cy="0" r="2" fill="#F57C00"></circle><circle cx="14" cy="0" r="2" fill="#F57C00"></circle></g>`;
    }),
    ...
    (OrgChart.templates.mery.node = function (t, e, r, i) {
        return `<rect x="0" y="0" height="${t.h}" width="${t.w}" fill="#ffffff" stroke-width="1" stroke="#686868" rx="50" ry="50"></rect><rect x="0" y="${t.h / 2 - 15}" height="30" width="${t.w}" fill="#039BE5" stroke-width="1"></rect>`;
    }),
    ...
    (OrgChart.templates.mery.img_0 = function (t, e, r, i, n) {
        var a = t.w / 2,
            o = t.h / 2,
            s = OrgChart.randomId();
        return `<clipPath id="${s}"><circle cx="${a}" cy="${o}" r="24"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${s})" xlink:href="${n}" x="${a - 24}" y="${o - 24}" width="48" height="48" ></image>`;
    }),
    ...
    (OrgChart.templates.mery.nodeMenuButton = function (t, e, r, i) {
        return `<g transform="matrix(1,0,0,1,${t.w - 25}, ${t.h / 2})"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>`;
    }),
    ...
    (OrgChart.templates.polina.nodeMenuButton = function (t, e, r, i) {
        return `<g transform="matrix(1,0,0,1,${t.w - 15},33)"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="0" cy="7" r="2" fill="#ffffff"></circle><circle cx="0" cy="14" r="2" fill="#ffffff"></circle></g>`;
    }),
    ...
    (OrgChart.templates.mila.node = function (t, e, r, i) {
        return `<rect x="0" y="0" height="${t.h}" width="${t.w}" fill="#039BE5" stroke-width="1" stroke="#aeaeae"></rect><rect x="-5" y="${t.h - 50}" height="30" width="${t.w + 10}" fill="#ffffff" stroke-width="1" stroke="#039BE5"></rect><line x1="-5" x2="0" y1="${t.h - 20}" y2="${t.h - 15}" stroke-width="1" stroke="#039BE5"/><line x1="${t.w + 5}" x2="${t.w}" y1="${t.h - 20}" y2="${t.h - 15}" stroke-width="1" stroke="#039BE5"/>`;
    }),
    (OrgChart.templates.mila.img_0 = function (t, e, r, i, n) {
        return `<image preserveAspectRatio="xMidYMid slice" xlink:href="${n}" x="20" y="${t.h - 115}"  width="64" height="64"></image>`;
    }),
    ...
    (OrgChart.templates.mila.nodeMenuButton = function (t, e, r, i) {
        return `<g transform="matrix(1,0,0,1,${t.w - 25},${t.h - 10})"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>`;
    }),
    ...
    (OrgChart.templates.diva.node = function (t, e, r, i) {
        return `<rect x="0" y="80" height="${t.h - 80}" width="${t.w}" fill="#039BE5"></rect><circle cx="${t.w / 2}" cy="50" fill="#ffffff" r="50" stroke="#039BE5" stroke-width="2"></circle>`;
    }),
    (OrgChart.templates.diva.img_0 = function (t, e, r, i, n) {
        var a = t.w / 2,
            o = OrgChart.randomId();
        return `<clipPath id="${o}"><circle cx="${a}" cy="50" r="45"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${o})" xlink:href="${n}" x="${a - 45}" y="5" width="90" height="90" ></image>`;
    }),
    ...
    (OrgChart.templates.diva.nodeMenuButton = function (t, e, r, i) {
        return `<g transform="matrix(1,0,0,1,${t.w - 30}, ${t.h - 15})"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>`;
    }),
    ...
    (OrgChart.templates.isla.img_0 = function (t, e, r, i, n) {
        var a = OrgChart.randomId();
        return `<clipPath id="${a}"><rect filter="url(#isla-shadow)" fill="#ffffff" stroke="#039BE5" stroke-width="1" x="${t.w / 2 - 20}" y="0" rx="13" ry="13" width="40" height="40"></rect></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${a})" xlink:href="${n}" x="${t.w / 2 - 20}" y="0"  width="40" height="40"></image>`;
    }),
    ...
    (OrgChart.templates.isla.nodeMenuButton = function (t, e, r, i) {
        return `<g transform="matrix(1,0,0,1,${t.w / 2 - 7},45)"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#F57C00"></circle><circle cx="7" cy="0" r="2" fill="#F57C00"></circle><circle cx="14" cy="0" r="2" fill="#F57C00"></circle></g>`;
    }),
    ...
    (OrgChart.templates.deborah.nodeMenuButton = function (t, e, r, i) {
        return `<g style="cursor:pointer;" transform="matrix(1,0,0,1,${t.w - 25},${t.h - 20})"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>`;
    }),
    ...
    (OrgChart.templates.clara.img_0 = function (t, e, r, i, n) {
        ...
        return `<clipPath id="${l}"><circle cx="${a}" cy="${o}" r="${s}"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#${l})" xlink:href="${n}" x="${a - s}" y="${o - s}" width="${2 * s}" height="${2 * s}" ></image>`;
    }),
    ...
    (OrgChart.templates.treeListItem.minus = function (t, e, r, i) {
        var n = r.expandCollapseSize / 2 + t.level * r.expandCollapseSize,
            a = t.h / 2;
        return `<g transform="matrix(1,0,0,1,${n},${(a -= r.expandCollapseSize / 2)})"><path fill="${"dark" == i.mode ? "#ccc" : "#757575"}" d="M7.42,8.59L12,13.17L16.59,8.59L18,10L12,16L6,10L7.42,8.59Z" /><rect style="opacity: 0" x="-3" y="-3" width="30" height="30"></rect></g>`;
    }),
    (OrgChart.templates.treeListItem.nodeMenuButton = function (t, e, r, i) {
        var n = "dark" == i.mode ? "#ccc" : "#757575";
        return `<g style="cursor:pointer;" transform="matrix(1,0,0,1, ${t.w - 36}, ${t.h / 2 - 13})">\n                <rect x="0" y="0" fill="red" style="opacity: 0;"  width="26" height="26"></rect>\n                <circle cx="13" cy="6" r="2" fill="${n}"></circle>\n                <circle cx="13" cy="13" r="2" fill="${n}"></circle>\n                <circle cx="13" cy="20" r="2" fill="${n}"></circle>\n        </g>`;
    }),
    ...
    (OrgChart.t = function (t, e, r) {
        ...
        if (null != r && i.scaleLessThen) {
            ...
            if (a.length > 0) {
                ...
                for (var h in l)
                    (null == n && (n = Object.assign({}, i)), (n[h] = l[h]));
            }
        }
        return e
            ? null == n
...
((OrgChart._ai = function (t) {
    ...
    (function (t, e) {
        ...
        function K(t, e) {
            ...
            } else if (a.escapeTestNoEncode.test(t))
                return t.replace(a.escapeReplaceNoEncode, W);
            return t;
        }
        function J(t) {
            try {
            ...
            if (!1 !== OrgChart.events.publish("change", [this, e])) {
                ...
                if (!r || !i) {
                    ...
                    (n.classList.add("boc-undo-redo"),
                        (n.innerHTML = `<span data-undo>${OrgChart.icon.undo(50, 50, "")}<span class="boc-undo-i"></span></span>\n                            <span data-redo>${OrgChart.icon.redo(50, 50, "")}<span class="boc-redo-i"></span></span>`),
            ...
            : {
                html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${n.disabledAttribute} ${n.vlidators}>\n                        <label for="${n.id}">${OrgChart._escapeGreaterLessSign(n.label)}</label>\n                        <select data-binding="${OrgChart._escapeDoubleQuotes(n.binding)}" ${n.readOnlyAttribute} id="${n.id}" name="${n.id}">\n                            ${(function () {
                    for (var t = "", e = 0; e < n.options.length; e++) {
                        var r = n.options[e];
                        t += `<option ${r.value == n.value ? "selected" : ""} value="${OrgChart._escapeDoubleQuotes(r.value)}">${OrgChart._escapeGreaterLessSign(r.text)}</option>`;
                    }
                    return t;
                })()}                           \n                        </select>\n                    </div>\n                </div>`,
                id: n.id,
        ...
        return n.doNotRender
            ...
            : {
                html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${n.disabledAttribute} ${n.vlidators}>\n                        <label for="${n.id}">${OrgChart._escapeGreaterLessSign(n.label)}</label>\n                        <select class="multiple" data-binding="${OrgChart._escapeDoubleQuotes(n.binding)}" ${n.readOnlyAttribute} id="${n.id}" name="${n.id}" multiple>\n                            ${(function () {
                    for (var t = "", e = 0; e < n.options.length; e++) {
                        var r = n.options[e];
                        t += `<option ${n.value.includes(r.value) ? "selected" : ""} value="${OrgChart._escapeDoubleQuotes(r.value)}">${OrgChart._escapeGreaterLessSign(r.text)}</option>`;
                    }
                    return t;
                })()}                           \n                        </select>\n                    </div>\n                </div>`,
                id: n.id,
