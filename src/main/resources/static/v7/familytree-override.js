...
// FamilyTree.remote._fromReqDTO → lokal /api/layout1new/calculate
...
(function () {
    ...
    FamilyTree.remote._fromReqDTO = function (nodes, roots, configs, callback) {
        ...
        fetch('/api/layout1new/calculate', {
            method: 'POST',
    ...
    console.log('[FT-override v2] FamilyTree.remote._fromReqDTO → /api/layout1new/calculate (oflayn+diagnoz)');
})();
